 ...
 */
public class 
HeartBeatConnection implements Connection
{
    private final Connection connection;
    private final int        heartbeat_interval;
    private final static int DEFAULT_HEARTBEAT_INTERVAL = 5 * 60 * 1000; // 5 minutes
     ...
     */
    public 
    HeartBeatConnection( Connection connection, String select_query )
    {
     ...
     */
    public 
    HeartBeatConnection( Connection connection, int heartbeat_interval, String select_query )
    {
        this.connection = connection;
        this.heartbeat_interval = heartbeat_interval;
        this.select_query = select_query;
        this.ripper = new Thread( new Runnable() { public void 
                                                   run()
                                                   {  
                                                 leave: do
                                                        {
...
//    	log.info( "close() method called from:", new Throwable().fillInStackTrace() );
    ...
    @Override public DatabaseMetaData 
    ...
    @Override public Map<String, Class<?>> 
    ...
    @Override public CallableStatement 
    ...
    /* 1.8 methods */
    @Override public void
    setSchema( String schema ) throws SQLException
    {
    ...
    @Override public void
    abort( Executor executor ) throws SQLException
    {
    ...
    @Override public void
    setNetworkTimeout( Executor executor, int milliseconds ) throws SQLException
    {
    ...
    @Override public int
    getNetworkTimeout() throws SQLException
    {
