...
class ProcessServiceTester {
  ...
  public void testGetActiveCompletedFailedPendingSamePriority() {
    ...
    assertThat(service.getActiveProcesses(pipelineName, launcherName, DEFAULT_LIMIT)).hasSize(2);
  ...
  public void testGetActiveCompletedFailedPendingDifferentPriority() {
    ...
    assertThat(service.getActiveProcesses(pipelineName, launcherName, DEFAULT_LIMIT))
