...
@SpringBootTest(
    ...
    properties = {
      ...
      "pipelite.service.name=PipeliteSchedulerResumeTest",
      "pipelite.advanced.processRunnerFrequency=250ms"
    })
@ActiveProfiles({"test", "PipeliteSchedulerResumeTest"})
@DirtiesContext(classMode = DirtiesContext.ClassMode.AFTER_CLASS)
public class PipeliteSchedulerResumeTest {
  ...
  @Autowired private PipeliteSchedulerTest.TestSchedule resume1;
  @Autowired private PipeliteSchedulerTest.TestSchedule resume2;

  @Profile("PipeliteSchedulerResumeTest")
  @TestConfiguration
  static class TestConfig {
    @Bean
    public PipeliteSchedulerTest.TestSchedule resume1() {
      return new PipeliteSchedulerTest.TestSchedule(
          1, 2, 2, PipeliteSchedulerTest.StageTestResult.SUCCESS);
    }

    @Bean
    public PipeliteSchedulerTest.TestSchedule resume2() {
      return new PipeliteSchedulerTest.TestSchedule(
          1, 2, 1, PipeliteSchedulerTest.StageTestResult.SUCCESS);
    }
  }
