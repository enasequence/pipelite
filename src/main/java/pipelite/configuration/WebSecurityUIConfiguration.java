...
@Configuration
@Order(2)
public class WebSecurityUIConfiguration extends WebSecurityConfigurerAdapter {

  private final UserDetailsConfiguration userDetailsConfiguration;

  public WebSecurityUIConfiguration(@Autowired UserDetailsConfiguration userDetailsConfiguration) {
