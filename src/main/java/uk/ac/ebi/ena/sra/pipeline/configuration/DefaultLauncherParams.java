...
public class DefaultLauncherParams {
  ...
  public final String lock = "/var/tmp/.launcher.lock";

  @Parameter(names = "--memory-limit", description = "memory per stage")
  public final int lsf_mem = DefaultConfiguration.currentSet().getDefaultLSFMem();

  @Parameter(names = "--cpu-cores-limit", description = "CPU cores per stage")
  public final int lsf_cpu_cores = DefaultConfiguration.currentSet().getDefaultLSFCpuCores();

  @Parameter(names = "--queue", description = "LSF queue name")
  public final String queue_name = DefaultConfiguration.currentSet().getDefaultLSFQueue();

  @Parameter(names = "--log-file", description = "log file")
  public final String log_file = "/var/tmp/launcher.log";

  @Parameter(
      names = "--lsf-mem-timeout",
      description = "timeout in minutes for lsf memory reservation")
  public final int lsf_mem_timeout = DefaultConfiguration.currentSet().getDefaultLSFMemTimeout();
}
