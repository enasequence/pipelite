...
public class ExecutionInstance {
  ...
  public boolean equals(Object another) {
    ...
    return (null == this.EXEC_ID
            ? null == ((ExecutionInstance) another).EXEC_ID
            : this.EXEC_ID.equals(((ExecutionInstance) another).EXEC_ID))
        && (null == this.EXEC_START
            ? null == ((ExecutionInstance) another).EXEC_START
            : this.EXEC_START.equals(((ExecutionInstance) another).EXEC_START))
        && (null == this.EXEC_DATE
            ? null == ((ExecutionInstance) another).EXEC_DATE
            : this.EXEC_DATE.equals(((ExecutionInstance) another).EXEC_DATE))
        && (null == this.EXEC_RESULT_TYPE
            ? null == ((ExecutionInstance) another).EXEC_RESULT_TYPE
            : this.EXEC_RESULT_TYPE.equals(((ExecutionInstance) another).EXEC_RESULT_TYPE))
        && (null == this.EXEC_RESULT
            ? null == ((ExecutionInstance) another).EXEC_RESULT
            : this.EXEC_RESULT.equals(((ExecutionInstance) another).EXEC_RESULT))
        && (null == this.EXEC_STDOUT
            ? null == ((ExecutionInstance) another).EXEC_STDOUT
            : this.EXEC_STDOUT.equals(((ExecutionInstance) another).EXEC_STDOUT))
        && (null == this.EXEC_STDERR
            ? null == ((ExecutionInstance) another).EXEC_STDERR
            : this.EXEC_STDERR.equals(((ExecutionInstance) another).EXEC_STDERR))
        && (null == this.EXEC_CMDLINE
            ? null == ((ExecutionInstance) another).EXEC_CMDLINE
            : this.EXEC_CMDLINE.equals(((ExecutionInstance) another).EXEC_CMDLINE));
  }
  ...
  public void setExceutionId(String execution_id) {
  ...
  public TaskoExecutionResultType getResultType() {
    return EXEC_RESULT_TYPE;
  }

  public void setResultType(TaskoExecutionResultType result_type) {
  ...
  public void setCmdLine(String exec_cmdline) {
