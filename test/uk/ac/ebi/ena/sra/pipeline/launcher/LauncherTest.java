...
LauncherTest
{
    ...
    {
        PipeliteLauncher.TaskIdSource id_src = new PipeliteLauncher.TaskIdSource() 
        {
            int index = 10;
        ...
        StageExecutorFactory e_src = new StageExecutorFactory() 
        {
            @Override public StageExecutor getExecutor() { return null; }
        }; 
...
log.info( "Completed: " + pool.getCompletedTaskCount() + " for " + ( finish - start ) + " mS using " + workers + " thread(s)" );
